  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        title="Service Contracts & Agreements List"
        subtitle="Master register of equipment maintenance agreements, payment installment terms, and verified settlement records."
        icon={FileText}
      />
