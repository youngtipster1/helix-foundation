...
function WelcomePortalPage() {
  ...
  const modules: WorkspaceModule[] = [
    ...
    },
    {
      ...
      description: "Service job dispatch, live engineer workspace, parts/labour tracking, and post-service debriefs.",
      icon: MessageSquareCode,
      status: "available",
      statusLabel: "Available",
      href: "/app/debrief",
      getRoute: (u) => (isModuleAdmin(u, "debrief") ? "/app/debrief" : "/app/debrief/my-work"),
      hasAccess: (u) => hasModuleAccess(u, "debrief"),
      notificationCount: notificationSummary.debriefCount,
    },
    {
      id: "financial",
      title: "Financial",
    ...
    },
    {
      ...
      status: "available",
      statusLabel: "Available",
      href: "/app/assets/dashboard",
      getRoute: () => "/app/assets/dashboard",
      hasAccess: (u) => hasModuleAccess(u, "assets"),
      notificationCount: notificationSummary.assetsCount,
    },
    {
      id: "parts",
    ...
    },
    {
      ...
      description: "Consolidated executive dashboards: Assets, Debrief, Financials, Inventory, Tools, and Quality governance.",
      icon: LayoutGrid,
      status: "available",
      statusLabel: "Available",
      href: "/app/management/assets",
      getRoute: () => "/app/management/assets",
      hasAccess: (u) => hasModuleAccess(u, "management"),
    },
    {
      id: "kpi",
      title: "KPI & Metrics",
